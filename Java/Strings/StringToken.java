...
Output Format
In the first line, print number of words  in the string. The words don't need to be unique. In the next lines, print all the words you found in the order they appeared in the input.
